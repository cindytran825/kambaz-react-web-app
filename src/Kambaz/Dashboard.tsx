...
//                 )).length}) <Button className="float-end" variant="primary"> Enrollments </Button>
//                 </h2> <hr />
...
{currentUser && currentUser.role === "STUDENT" || currentUser.role === "TA" || currentUser.role === "ADMIN" || currentUser.role === "FACULTY" && (
  <>
    <Button
