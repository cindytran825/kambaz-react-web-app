  ...
  return (
    <div id="wd-lab1">
      ...
      <div id="wd-h-tag">
        ...
        text so that it renders in a browser as large headings. There are 6 heading
      ...
      <div id="wd-p-tag">
        ...
        <p id="wd-p-1">
          ...
          and render all the text as one single set of sentences. To force the browser to add
      ...
      <ol id="wd-your-favorite-recipe">
        ...
        <li>Mix slowly.</li>
        <li>Section and leave in freezer for 24 hours.</li>
        <li>Bake in 350 degrees for 12 minutes.</li>
        <li>Serve and enjoy!</li>
      </ol>
      ...
      Please
      <a href="https://github.com/cindytran825/kambaz-react-web-app" id="wd-github"> click here </a>
      for my github!<br />
